...
public class ElevatorSubsystem extends SubsystemBase {
  ...
  public void armTelescopeState()
  {
    ...
    switch(armTelescopeStateCurrent)
    {
      ...
      break;
      case L2: armTelescopePID.setReference(Constants.ElevatorConstants.LEVEL_TWO, ControlType.kPosition);
      break;
      case L3: armTelescopePID.setReference(Constants.ElevatorConstants.LEVEL_THREE, ControlType.kPosition);
      break;
      case L4: armTelescopePID.setReference(Constants.ElevatorConstants.LEVEL_FOUR, ControlType.kPosition);
      break;
      case DRIVE: armTelescopePID.setReference(Constants.ElevatorConstants.DRIVE, ControlType.kPosition);
      break;
      case INTAKE: armTelescopePID.setReference(Constants.ElevatorConstants.INTAKE, ControlType.kPosition);
      break;
